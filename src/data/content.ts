...
export const steps: Step[] = [
  ...
  { n: "03", title: "Aktivasi Cepat", desc: "Akun siap <24 jam", detail: "Akun aktif & siap login di Android/PC. Atur header struk, cek saldo real-time, langsung bisa transaksi tanpa ribet.", icon: "ShieldCheck", accent: "bg-amber-500" },
...
export const faqs: FAQ[] = [
  ...
  { q: "Apakah struk bisa dikustom & cetak ulang?", a: "Ya. Atur header/footer (nama loket, alamat, WA) langsung di aplikasi. Dukung Thermal 58/80mm Bluetooth/USB, Dot Matrix, Inkjet/Laser A4/F4 & Portable. Riwayat transaksi bisa cetak ulang kapan saja dan export laporan digital.", category: "Fitur" },
